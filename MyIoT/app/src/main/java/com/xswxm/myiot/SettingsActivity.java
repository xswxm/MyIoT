...
public class SettingsActivity extends AppCompatPreferenceActivity {
    ...
    public static String toStars(String text) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int value = SpUtils.getInt(this, Constants.SYNCINTERVAL);
        SpUtils.removeKey(this, Constants.SYNCINTERVAL);
        SpUtils.putString(this, Constants.SYNCINTERVAL, Integer.toString(value));
